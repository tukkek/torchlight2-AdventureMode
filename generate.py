...
def makedungeons(maps,icon):
  for m in maps:
    yield m
    for t in tiers:
      dungeonname=f'am_{m.dungeonname}'
      ...
      mapname=f'am_map_{m.dungeonname}'
